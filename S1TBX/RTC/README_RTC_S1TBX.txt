...
This folder contains Radiometric Terrain Corrected (RTC) products and their associated files. They were generated by the Alaska Satellite Facility (ASF) HYP3 RTC-S1TBX software version [HYP3_VER], running Sentinel-1 Toolbox (S1TBX) release [S1TBX_VER]. The pixel spacing is [SPACING] m.
